...
def main():
    ...
    problem_salmon_sushi = Problem("salmon_sushi")
    problem_salmon_sushi.add_objects([rice_p,fish_p,nori_p,rack,stove,board,cus])
    problem_salmon_sushi.add_fluent(At, default_initial_value=False)
    problem_salmon_sushi.add_fluent(Has_plate, default_initial_value=False)
    problem_salmon_sushi.add_fluent(plate_in_hand, default_initial_value=False)
    problem_salmon_sushi.add_fluent(fish_in_hand, default_initial_value=False)
    problem_salmon_sushi.add_fluent(Placed_in, default_initial_value=False)
    problem_salmon_sushi.add_fluent(Has_pot, default_initial_value=False)
    problem_salmon_sushi.add_fluent(pot_in_hand, default_initial_value=False)
    problem_salmon_sushi.add_fluent(Cooked, default_initial_value=False)
    problem_salmon_sushi.add_fluent(Chopped, default_initial_value=False)
    problem_salmon_sushi.add_fluent(Has_rice, default_initial_value=False)
    problem_salmon_sushi.add_fluent(Has_fish, default_initial_value=False)
    problem_salmon_sushi.add_fluent(Has_nori, default_initial_value=False)
    problem_salmon_sushi.add_fluent(rice_in_plate, default_initial_value=False)
    problem_salmon_sushi.add_fluent(fish_in_plate, default_initial_value=False)
    problem_salmon_sushi.add_fluent(nori_in_plate, default_initial_value=False)
    problem_salmon_sushi.add_fluent(Can_cook, default_initial_value=False)
    problem_salmon_sushi.add_fluent(Can_chop, default_initial_value=False)
    problem_salmon_sushi.add_fluent(Has_customer, default_initial_value=False)
    problem_salmon_sushi.add_fluent(Served, default_initial_value=False)
    problem_salmon_sushi.add_fluent(Distance1, default_initial_value=False)
    problem_salmon_sushi.add_fluent(Distance2, default_initial_value=False)
    problem_salmon_sushi.add_fluent(Distance3, default_initial_value=False)
    problem_salmon_sushi.add_fluent(Distance4, default_initial_value=False)
    problem_salmon_sushi.add_fluent(Distance5, default_initial_value=False)
    problem_salmon_sushi.add_fluent(Distance6, default_initial_value=False)
    problem_salmon_sushi.add_fluent(Distance7, default_initial_value=False)
    problem_salmon_sushi.add_fluent(Distance8, default_initial_value=False)
    problem_salmon_sushi.add_fluent(Distance9, default_initial_value=False)
    problem_salmon_sushi.add_fluent(Distance10, default_initial_value=False)
    problem_salmon_sushi.add_fluent(Distance11, default_initial_value=False)
    problem_salmon_sushi.add_fluent(Distance12, default_initial_value=False)
    problem_salmon_sushi.add_action(take_pot)
    problem_salmon_sushi.add_action(take_plate)
    problem_salmon_sushi.add_action(collect_rice)
    problem_salmon_sushi.add_action(cook_rice)
    problem_salmon_sushi.add_action(collect_fish)
    problem_salmon_sushi.add_action(chop_fish)
    problem_salmon_sushi.add_action(collect_processed_rice)
    problem_salmon_sushi.add_action(collect_processed_fish)
    problem_salmon_sushi.add_action(collect_nori)
    problem_salmon_sushi.add_action(serve)
    problem_salmon_sushi.add_action(Travel_distance_1)
    problem_salmon_sushi.add_action(Travel_distance_2)
    problem_salmon_sushi.add_action(Travel_distance_3)
    problem_salmon_sushi.add_action(Travel_distance_4)
    problem_salmon_sushi.add_action(Travel_distance_5)
    problem_salmon_sushi.add_action(Travel_distance_6)
    problem_salmon_sushi.add_action(Travel_distance_7)
    problem_salmon_sushi.add_action(Travel_distance_8)
    problem_salmon_sushi.add_action(Travel_distance_9)
    problem_salmon_sushi.add_action(Travel_distance_10)
    problem_salmon_sushi.add_action(Travel_distance_11)
    problem_salmon_sushi.add_action(Travel_distance_12)

    mac = {take_pot:Int(0), take_plate:Int(0), collect_rice:Int(0), cook_rice:Int(0), collect_fish:Int(0), chop_fish:Int(0), collect_processed_rice:Int(0), collect_processed_fish:Int(0), collect_nori:Int(0), serve:Int(0), Travel_distance_1:Int(37849), Travel_distance_2:Int(28849), Travel_distance_3:Int(20566), Travel_distance_4:Int(33849), Travel_distance_5:Int(22566), Travel_distance_6:Int(22566), Travel_distance_7:Int(26566), Travel_distance_8:Int(19560), Travel_distance_9:Int(34849), Travel_distance_10:Int(41849), Travel_distance_11:Int(58130), Travel_distance_12:Int(77410)} # This is the dictionary that stores the action costs
    problem_salmon_sushi.add_quality_metric(up.model.metrics.MinimizeActionCosts(mac))

    # Declaring the initial state
    problem_salmon_sushi.set_initial_value(At(rack),True)
    problem_salmon_sushi.set_initial_value(Has_plate(rack),True)
    problem_salmon_sushi.set_initial_value(Has_pot(rack),True)
    problem_salmon_sushi.set_initial_value(Has_rice(rice_p),True)
    problem_salmon_sushi.set_initial_value(Has_fish(fish_p),True)
    problem_salmon_sushi.set_initial_value(Has_nori(nori_p),True)
    problem_salmon_sushi.set_initial_value(Can_cook(stove),True)
    problem_salmon_sushi.set_initial_value(Can_chop(board),True)
    problem_salmon_sushi.set_initial_value(Has_customer(cus),True)
    problem_salmon_sushi.set_initial_value(Distance1(rice_p,stove),True)
    problem_salmon_sushi.set_initial_value(Distance1(stove,rice_p),True)
    problem_salmon_sushi.set_initial_value(Distance2(rice_p,rack),True)
    problem_salmon_sushi.set_initial_value(Distance2(rack,rice_p),True)
    problem_salmon_sushi.set_initial_value(Distance3(rack,stove),True)
    problem_salmon_sushi.set_initial_value(Distance3(stove,rack),True)
    problem_salmon_sushi.set_initial_value(Distance4(rack,nori_p),True)
    problem_salmon_sushi.set_initial_value(Distance4(nori_p,rack),True)
    problem_salmon_sushi.set_initial_value(Distance5(rack,board),True)
    problem_salmon_sushi.set_initial_value(Distance5(board,rack),True)
    problem_salmon_sushi.set_initial_value(Distance6(stove,fish_p),True)
    problem_salmon_sushi.set_initial_value(Distance6(fish_p,stove),True)
    problem_salmon_sushi.set_initial_value(Distance7(stove,board),True)
    problem_salmon_sushi.set_initial_value(Distance7(board,stove),True)
    problem_salmon_sushi.set_initial_value(Distance8(fish_p,board),True)
    problem_salmon_sushi.set_initial_value(Distance8(board,fish_p),True)
    problem_salmon_sushi.set_initial_value(Distance9(board,nori_p),True)
    problem_salmon_sushi.set_initial_value(Distance9(nori_p,board),True)
    problem_salmon_sushi.set_initial_value(Distance10(nori_p,cus),True)
    problem_salmon_sushi.set_initial_value(Distance10(cus,nori_p),True)
    problem_salmon_sushi.set_initial_value(Distance11(board,cus),True)
    problem_salmon_sushi.set_initial_value(Distance11(cus,board),True)
    problem_salmon_sushi.set_initial_value(Distance12(stove,cus),True)
    problem_salmon_sushi.set_initial_value(Distance12(cus,stove),True)

    # Setting the goals
    problem_salmon_sushi.add_goal(At(cus))
    problem_salmon_sushi.add_goal(Served)

    # Solving the problem
    up.shortcuts.get_env().credits_stream = None
    with OneshotPlanner(name="fast-downward-opt") as planner:
        result = planner.solve(problem_salmon_sushi)
        plan = result.plan
        if plan is not None:
    ...
    w = PDDLWriter(problem_salmon_sushi)
    w.write_domain('domain_salmon_sushi.pddl')
    w.write_problem('problem_salmon_sushi.pddl')
    return
