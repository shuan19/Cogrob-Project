(define (domain fried_salmon_sushi-domain)
 ...
 (:action fry_fish
  :parameters ( ?loc - location)
  :precondition (and (at_ ?loc) (can_cook ?loc) (not (plate_in_hand)) (not (pot_in_hand)) (fish_in_hand) (chopped))
  :effect (and (fried) (increase (total-cost) 0)))
 ...
 (:action collect_processed_fish
  :parameters ( ?loc - location)
  :precondition (and (at_ ?loc) (can_chop ?loc) (plate_in_hand) (not (pot_in_hand)) (chopped) (fried) (not (fish_in_plate)))
